...
public class BankingOperations {
    ...
    private void loginUser() {
        ...
        User user = findUserById(accNumber);
        if (user != null) {
    ...
    private void checkBalance(User user) {
        ...
        System.out.println("Annual interest rate: " + User.getInterestRate() + "%");
        System.out.println("Monthly fee: Rs." + User.getMonthlyFee());
    }
    ...
    private void checkBalance() {
        ...
        User user = findUserById(accNumber);
        if (user != null) {
            // Print the balance and fixed interest rate and monthly fee
            System.out.println("Current balance: " + user.getBalance());
            System.out.println("Annual interest rate: " + User.getInterestRate() + "%");
            System.out.println("Monthly fee deduction: Rs." + User.getMonthlyFee());
        } else {
            System.out.println("Invalid account number.");
        }
    }

    private User findUserById(String accNumber) {
